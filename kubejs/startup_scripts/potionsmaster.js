global.potions_server = [
  ...
  StartupEvents.registry('item', floabg => {
     global.potions_server.forEach(potion => {
          floabg.create(`potionsmaster:calcinated_${potion.id}_oresight_powder`)
  ...
  StartupEvents.modifyCreativeTab('potionsmaster:creative_tab', floabg => {
    global.potions_server.forEach(potion => {
          floabg.add(`potionsmaster:calcinated_${potion.id}_oresight_powder`)
          floabg.add(`potionsmaster:${potion.id}_oresight_powder`)
      })
